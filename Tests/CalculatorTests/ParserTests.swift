...
final class ParserTests: XCTestCase {
  func testParse() {
    ...
    XCTAssertEqual(
      try parse(tokens: [
        DigitToken._1, SubToken.instance, DigitToken._2, SubToken.instance, DigitToken._3,
        SubToken.instance, DigitToken._4,
      ]),
      "((((1)-(2))-(3))-(4))"
    )
    XCTAssertEqual(
    ...
    XCTAssertEqual(
      try parse(tokens: [
        DigitToken._5, RootToken.instance, DigitToken._6, FunctionToken.sin, BracketToken.open,
        DigitToken._7, ConstToken.pi, BracketToken.close,
      ]),
      "((5)√(6*sin(7*π)))"
    )
    XCTAssertEqual(
